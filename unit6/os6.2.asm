...
// lpeek(dword zeropage($5c) address)
lpeek: {
    .label t = $30
    .label address = $5c
...
// memset(void* zeropage($66) str, byte register(X) c, word zeropage($14) num)
memset: {
    .label end = $14
    .label dst = $66
    .label num = $14
...
syscall0A: {
    ...
    ldy.z caller_pid
    ldx m+OFFSET_STRUCT_IPC_MESSAGE_TO
...
/** NO. 7 */
// get_next_message_id(byte zeropage($16) receiver)
get_next_message_id: {
    .label m = $7a
    .label receiver = $16
